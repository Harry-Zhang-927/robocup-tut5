...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/athome23-5/tiago_public_ws/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/athome23-5/tiago_public_ws/devel/.private/controller_manager_tests)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/athome23-5/tiago_public_ws/install)
...
if(NOT "/home/athome23-5/tiago_public_ws/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/athome23-5/tiago_public_ws/src/ros_control/controller_manager_tests/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/athome23-5/tiago_public_ws/src/ros_control/controller_manager_tests/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/athome23-5/tiago_public_ws/devel/.private/controller_manager_tests/lib;/home/athome23-5/tiago_public_ws/devel/lib;/opt/ros/noetic/lib)
